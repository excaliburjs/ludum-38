...
var Player = (function (_super) {
    ...
    Player.prototype.onInitialize = function (engine) {
        ...
        this.on('postdraw', function (evt) {
            _this._selectSprite.draw(evt.ctx, -_this._selectSprite.naturalWidth / 2, _this._selectSprite.naturalHeight / 2);
        });
    };
...
var Resources = {
    ...
    charSheet5: new ex.Texture('img/char-sprites/player-5.png'),
    charSheet6: new ex.Texture('img/char-sprites/player-1-long.png'),
    charSheet7: new ex.Texture('img/char-sprites/player-2-long.png'),
    charSheet8: new ex.Texture('img/char-sprites/player-3-long.png'),
    charSheet9: new ex.Texture('img/char-sprites/player-4-long.png'),
    charSheet10: new ex.Texture('img/char-sprites/player-5-long.png'),
